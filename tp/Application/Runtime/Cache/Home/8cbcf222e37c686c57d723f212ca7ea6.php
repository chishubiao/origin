                        ...
                        <table cellspacing="0" cellpadding="0" width="69%" align="center" border="0">
                            ...
                            <tr>
                                ...
                                <td width="53%" align="left">
                                    <input  class="button" type="button" value="不同意"  onclick="button1()">
                                    &nbsp;&nbsp;
                                    <input  type="button" value="同意" id="Submit2" name="Submit2" class="button" onclick="button2()">
